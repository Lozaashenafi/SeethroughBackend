...
CREATE INDEX "idx_comment_user" ON "comments" USING btree ("user_id");--> statement-breakpoint
...
CREATE INDEX "idx_report_user" ON "reports" USING btree ("user_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_review_user_company_unique" ON "reviews" USING btree ("user_id","company_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_review_vote_unique" ON "review_votes" USING btree ("review_id","user_id");--> statement-breakpoint
...
CREATE INDEX "idx_user_verification_token" ON "users" USING btree ("verification_token");